...
public class OpenserverRequest {
	...
	private OpenserverClientConfiguration config;

	public OpenserverRequest() {
	...
	public OpenserverRequest(HashMap<String, String> header, HashMap<String, String> bodyParams) {
		headers = header;
		params = bodyParams;
	}
	...
	public OpenserverClientConfiguration getConfig() {
		return config;
	}

	public void setConfig(OpenserverClientConfiguration config) {
		this.config = config;
	}
}

package com.bayside.openserver.util;

import com.bayside.openserver.exception.OpenserverException;
...
public class SignUtil {
	...
	public static String hmacSha256(String key, String data) throws OpenserverException {
		try {
			...
			e.printStackTrace();
			throw new OpenserverException(-1, "Fail to generate HMAC-SHA256 signature");
		}
	}
